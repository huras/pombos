...
<div class="container" id='meu-body'>
                    ...
                    <div class="card-body">
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <h6 class="d-block"><a style="color: #D9230F">Idade: </a>{{ (($pombo->nascimento == NULL) ? 'Sem data de nascimento' : ($interval->y).' anos') }}</h6>
        ...
        <a class="btn btn-danger" href='/pombos'> Voltar </a>
    </div>
