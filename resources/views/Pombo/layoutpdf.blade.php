...
<div class="image-container" style="display: flex; justify-content: center;margin-bottom: 25px;">    
    <img src="{{ (isset($pombo->foto)) ? '/public/img/pombo/'{{$item->foto}} : 'https://www.policiajudiciaria.pt/wp-content/uploads/2004/04/sem-foto.jpg'}}" id="imgProfile" style="width: 320px; height: 240px;  margin-top: 15px;" class="img-thumbnail" />                                     
</div>
